...
import BotonPdfMedidaCorrectiva from "../../components/medidas/BotonPdfMedidaCorrectiva";
      ...
      {modal === "detalle" && selected && (
        <div className="mc-modal-backdrop">
          <div className="mc-modal detail enterprise-detail">
            <div className="mc-modal-header"><div><h2>{selected.codigo}</h2><p>{selected.titulo}</p></div><button onClick={() => setModal(null)}><X size={18} /></button></div>
